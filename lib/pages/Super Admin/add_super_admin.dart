          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  decoration: InputDecoration(
                    labelText: "Prenom de Super Admin",
                    hintText: "Entrer le prenom de Super Admin",
                    border: OutlineInputBorder(),
                  ),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      ...
                      if (_formKey.currentState!.validate()) {
                        ...
                        try {
                          ...
                          await _authServices.signUpWithEmailAndPassword(
                              mail, password, 'super_admin');
                          if (user != null) {
                            String uid = user.uid;
                            // Add to superadmin collection
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text(
                                      "Super Admin ajouté avec succès")),
                            );
                          }
                        } catch (error) {
                          ScaffoldMessenger.of(context).showSnackBar(
